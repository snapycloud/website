				...
				<div class="footer-top no-padding-bottom">
					<div class="row">
						<div class="column width-12 center">
							<div class="widget">
								<h3 class="mb-30">Snapy Cloud Very Fastly</h3>
								<p class="lead mb-30 rtl">ارائه دهنده پلتفرم سرویس api و نرم افزار مدیریت ارتباط با مشتری<br>اسنپی کلود</p>
					...
					<div class="row">
						<div class="column width-12">
							<div class="footer-bottom-inner">
								<p class="copyright center">© SnapyCloud. All Rights Reserved.</p>
							</div>
						</div>
					</div>
				</div>
